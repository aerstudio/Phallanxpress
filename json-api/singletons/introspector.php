...
class JSON_API_Introspector {
  ...
  public function get_current_category() {
    global $json_api;
    extract($json_api->query->get(array('id', 'slug', 'category_id', 'category_slug', 'taxonomy')));
    if (!$taxonomy){
      $taxonomy = 'category';
    }
    if ($id || $category_id) {
  ...
  public function get_category_by_id($category_id, $taxonomy = 'category') {
    $wp_category = get_term_by('id', $category_id, $taxonomy);
    return $this->get_category_object($wp_category);
  }
  
  public function get_category_by_slug($category_slug, $taxonomy = 'category') {
