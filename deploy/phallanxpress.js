...
Phallanxpress || (Phallanxpress = {});
Phallanxpress.Models || (Phallanxpress.Models = {});
Phallanxpress.Collections || (Phallanxpress.Collections = {});
...
Phallanxpress.Collection = (function() {
  ...
  Collection.prototype._wpAPI = function(cmd, options) {
    var params, post_type, success, taxonomy, url;
    if (cmd == null) {
